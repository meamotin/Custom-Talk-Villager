...
## 対応バージョン Minecraft Java Edition 1.19.4 , 1.20
...
## ワールドに入り直すと交易情報が追加される
1.20版で新たに追加されたバグでしょうか？更新中に気づきました。緊急の対処として、元々取引情報を持っていなかった村人に「NoneOffer」というタグを付けて、会話の更新を行う際に対象がこのタグが付いた村人なら取引情報を削除するようにしました。このバグに困った方は会話の更新をしてみてくださいね。
