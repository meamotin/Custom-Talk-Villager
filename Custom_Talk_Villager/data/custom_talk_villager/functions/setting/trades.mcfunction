...
## 名前
    data modify entity @e[type=villager,tag=setting_ctv,sort=nearest,limit=1] CustomName set from block -8 8 47 Text1


## 交易
    data modify storage ctv: new_trades set from block -7 8 46 Items
